...
# 旅行検出（設置場所の履歴から「家」より離れているとみなす距離のしきい値）
TRAVEL_DISTANCE_THRESHOLD_KM = float(os.getenv("TRAVEL_DISTANCE_THRESHOLD_KM", "20"))
...
# earthquake_log の保存上限（超過分は古い順に削除。ディスク枯渇防止）
EARTHQUAKE_LOG_MAX_ROWS = int(os.getenv("EARTHQUAKE_LOG_MAX_ROWS", "1000"))
# ISS 通過通知
...
__all__ = [
    ...
    "P2PQUAKE_TSUNAMI_TARGET_AREAS", "EARTHQUAKE_LOG_MAX_ROWS",
